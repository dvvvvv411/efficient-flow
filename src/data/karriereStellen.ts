...
export const stellen: Stelle[] = [
  ...
  {
    slug: 'prozessberater',
    titel: 'Prozessberater:in',
    standort: 'München',
    modell: 'Hybrid',
    kurzbeschreibung: 'Analysiere Geschäftsprozesse und entwickle Digitalisierungsstrategien für unsere Kunden.',
    beschreibung: 'Als Prozessberater:in identifizierst du Optimierungspotenziale in den Abläufen unserer Kunden und entwickelst umsetzbare Strategien zur Digitalisierung. Du bist die Brücke zwischen Business-Anforderungen und technischer Umsetzung.',
    aufgaben: [
      'Analyse bestehender Geschäftsprozesse und Identifikation von Engpässen',
      'Entwicklung von Digitalisierungsstrategien und Roadmaps',
      'Workshop-Moderation mit Stakeholdern',
      'Erstellung von Business Cases und Entscheidungsvorlagen',
      'Begleitung der Umsetzung gemeinsam mit dem Entwicklungsteam',
    ],
    voraussetzungen: [
      'Abgeschlossenes Studium in BWL, Wirtschaftsinformatik oder vergleichbar',
      'Mindestens 3 Jahre Erfahrung in der Unternehmensberatung',
      'Erfahrung mit Prozessmodellierung (BPMN)',
      'Ausgeprägte analytische und kommunikative Fähigkeiten',
      'Fließende Deutsch- und Englischkenntnisse',
    ],
    benefits: [
      'Hybrides Arbeitsmodell (2 Tage Office, 3 Tage Remote)',
      'Direkte Zusammenarbeit mit Geschäftsführungen',
      'Abwechslungsreiche Projekte in verschiedenen Branchen',
      '30 Urlaubstage',
      'Firmenwagen oder ÖPNV-Zuschuss',
    ],
  },
  {
    slug: 'ux-ui-designer',
